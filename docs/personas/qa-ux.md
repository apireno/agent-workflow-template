...
- DOMShell needs `--allow-write` for `click`/`type`/`navigate`/**`screenshot`**; it drives a *real* Chrome via its extension (not headless) — see Operating Constraints for session standup.
